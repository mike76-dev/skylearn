...
if(address !==undefined){var ext=address[0],is_pkg=address[1]!==undefined,path=$B.path+"/"+
fullname.replace(/\./g,"/"),metadata={ext:ext,is_package:is_pkg,path:path+(is_pkg? ".py" :
